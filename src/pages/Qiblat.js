                ...
                <div className="relative mx-auto w-full max-w-sm aspect-square">
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="w-2 h-32 bg-gradient-to-t from-emerald-600 to-emerald-400 rounded-full shadow-lg relative -top-16">
                        <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[12px] border-l-transparent border-r-[12px] border-r-transparent border-b-[20px] border-b-emerald-400"></div>
                      </div>
                      {/* Needle pointing opposite */}
                      <div className="w-2 h-32 bg-gradient-to-b from-gray-400 to-gray-300 rounded-full shadow-lg relative -top-32">
                        <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[12px] border-l-transparent border-r-[12px] border-r-transparent border-t-[20px] border-t-gray-300"></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div
                    ...
                    style={{
                      transform: `translate(-50%, -50%) rotate(${getCompassRotation()}deg) translateY(-140px)`,
                      transition: "transform 0.1s linear",
                    }}
                  >
